          ...
          <div className="row">
            <div className="col-md-3">
              ...
              >
                ...
                <div className="card-body text-center">
                  <h5 className="card-title">Sản phẩm Lưới lan</h5>
                  <p className="card-text">
                    <i
                      style={{
                        color: "yellow",
                  ...
                  <p className="card-text">Genres: Action, Drama</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-3">
              ...
              >
                ...
                <div className="card-body text-center">
                <h5 className="card-title">Quạt máy ABC</h5>
                <p className="card-text">
                    <i
                      style={{
                        color: "yellow",
